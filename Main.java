	...
	public static void main(String[] args) {
		...
		System.out.println(ev1.getCidade().equals("Rio Grande"));
		 ...
		 // evento tem atividades 
		  ...
		  // satelites System.out.println(ev3.getEventosSatelites().length == 3);
		  ...
		  // as vagas decrescem System.out.println(atv1.getVagasRemanescentes() == 38);
		  ...
		  for (int i = 0; i < insc1chave.toString().length(); i++) { char c =  
		  insc1.getChave().toString().charAt(i);
		 ...
		 try { atv1.inscrever("Data");
		  System.out.println(false); }
		 catch (NaoHaVagaException e) {
		  System.err.println(true + " " + e); }
		  
		  // eventos satélite permitem inscrição sat1.inscrever("Geordi Laforge");
